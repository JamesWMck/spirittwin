...
export const translations = {
  ...
  privacy: {
    ...
    p3Desc: { en: 'Zero-knowledge authentication. Cryptographic identity lock. Granular access controls. Revocable power of attorney. Your data, your rules.', 'zh-CN': '\u96F6\u77E5\u8BC6\u8BA4\u8BC1\u3002\u52A0\u5BC6\u8EAB\u4EFD\u9501\u5B9A\u3002\u7CBE\u7EC6\u5316\u8BBF\u95EE\u63A7\u5236\u3002\u53EF\u64A4\u9500\u7684\u6308\u4E45\u6388\u6743\u4E66\u3002\u4F60\u7684\u6570\u636E\uFF0C\u4F60\u7684\u89C4\u5219\u3002', 'zh-HK': '\u96F6\u77E5\u8B58\u8A8D\u8B49\u3002\u52A0\u5BC6\u8EAB\u4EFD\u9396\u5B9A\u3002\u7CBE\u7D30\u5316\u8A2A\u554F\u63A7\u5236\u3002\u53EF\u64A4\u92B7\u7684\u6301\u4E45\u6388\u6B0A\u66F8\u3002\u4F60\u7684\u6578\u64DA\uFF0C\u4F60\u7684\u898F\u5247\u3002' },
  ...
  waitlist: {
    ...
    subtitle: {
      ...
      'zh-HK': '\u6211\u5011\u7528\u5FC3\u6253\u9020\u6BCF\u4E00\u500BS\u500BiritTwin\u3002\u540D\u984D\u6709\u9650\u3002',
    },
  ...
  products: {
    ...
    companionCN: { en: '生前实时陪伴', 'zh-CN': '生前实时陪伴', 'zh-HK': '生前即時陪伴' },
    companionPricing: { en: '¥15,800 one-time', 'zh-CN': '¥15,800 一次性', 'zh-HK': '¥15,800 一次性' },
    ...
    legacyCN: { en: '身后关键时刻触发', 'zh-CN': '身后关键时刻触发', 'zh-HK': '身後關鍵時刻觸發' },
    legacyPricing: { en: '¥9,999 add-on', 'zh-CN': '¥9,999 附加', 'zh-HK': '¥9,999 附加' },
    ...
    royaltiesCN: { en: '专业知识传承', 'zh-CN': '专业知识传承', 'zh-HK': '專業知識傳承' },
    royaltiesPricing: { en: '50% estate share', 'zh-CN': '50% 遗产分成', 'zh-HK': '50% 遺產分成' },
    ...
    onDemandCN: { en: '按时访问', 'zh-CN': '按时访问', 'zh-HK': '按時訪問' },
    onDemandPricing: { en: 'From ¥99/hr', 'zh-CN': '¥99/小时起', 'zh-HK': '¥99/小時起' },
