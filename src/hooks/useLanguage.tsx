...
export const translations = {
  ...
  hero: {
    ...
    questions: {
      ...
      q7: { en: 'What if the end is optional?', 'zh-CN': '\u5982\u679C\u4EBA\u751F\u6CA1\u6709\u7EC8\u70B9\uFF0C\u4F60\u4F1A\u5982\u4F55\u9009\u62E9?', 'zh-HK': '\u5982\u679C\u4EBA\u751F\u6C92\u6709\u7D42\u9EDE\uFF0C\u4F60\u6703\u5982\u4F55\u9078\u64C7?' },
    },
  },
  story: {
  ...
  waitlist: {
    ...
    successTitle: { en: 'Thank you for joining the waitlist', 'zh-CN': '感谢加入等候名单', 'zh-HK': '感謝加入等候名單' },
    successBody: { en: "Thank you for joining the SpiritTwin Waitlist. Our products and services are highly exclusive and memberships are by invitation only. We will contact you within 14 days to discuss SpiritTwin's membership requirements, onboarding process and product launch timeline. If you have any specific questions or requests, please contact us at contact@myspirittwin.ai.", 'zh-CN': '感谢加入SpiritTwin等候名单。我们的产品和服务高度专属，会员仅限邀请制。我们将在14天内与您联系，讨论SpiritTwin的会员资格要求、注册流程和产品发布时间表。如有任何具体问题或需求，请通过contact@myspirittwin.ai与我们联系。', 'zh-HK': '感謝加入SpiritTwin等候名單。我們的產品和服務高度專屬，會員僅限邀請制。我們將在14天內與您聯繫，討論SpiritTwin的會員資格要求、註冊流程和產品發布時間表。如有任何具體問題或需求，請通過contact@myspirittwin.ai與我們聯繫。' },
